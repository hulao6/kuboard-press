...
module.exports = {
  ...
  title: "Kuboard",
  description:
    "一款Kubernetes_Dashboard_简化Kubernetes的学习和使用_帮助您快速落地Kubernetes_提供_Kubernetes_免费中文教程_国内安装文档",
  head: [
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: "V4", link: "/v4/install/quickstart.html" },
      { text: "V3", link: "/install/v3/install.html" },
